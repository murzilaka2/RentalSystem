...
1. Создать страницу с контактами и реализовать возможность отправки писем на почту,
которую может указать админ в настройках сайта.
2. Сделать страницу с выводом диллеров и их количество авто, с возможностью
